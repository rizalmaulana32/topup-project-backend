...
import { XenditDisbursementWebhookController } from './webhook/xendit-disbursement-webhook.controller';
...
@Module({
  ...
  controllers: [AffiliatesController, XenditDisbursementWebhookController],
